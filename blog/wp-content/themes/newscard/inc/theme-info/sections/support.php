<div class="col-3 clearfix">
	...
	<div class="col">
		...
		<p><?php echo esc_html__('See the list on the latest version changes. Just see the changelog to get complete list of recent fixes and new features.', 'newscard'); ?></p>
